...
public class ElectricArcFurnaceRecipe implements Recipe<Container> {
    ...
    public ElectricArcFurnaceRecipe(ResourceLocation id,
    ...
    public RecipeSerializer<?> getSerializer() {
        return ModRecipes.ELECTRIC_ARC_FURNACE_SERIALIZER.get();
    }
    ...
    public static class Type implements RecipeType<ElectricArcFurnaceRecipe> {
        public static final Type INSTANCE = new Type();
        public static final String ID = "electric_arc_furnace";
    ...
    public static class Serializer implements RecipeSerializer<ElectricArcFurnaceRecipe> {
        @Override
        public ElectricArcFurnaceRecipe fromJson(ResourceLocation recipeId, JsonObject json) {
            ...
            int waterAmount = GsonHelper.getAsInt(json, "water_amount", 250);
            return new ElectricArcFurnaceRecipe(recipeId, primaryInput, secondaryInput, result, processTicks, energyPerTick, waterAmount);
        }

        @Override
        public ElectricArcFurnaceRecipe fromNetwork(ResourceLocation recipeId, FriendlyByteBuf buffer) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buffer, ElectricArcFurnaceRecipe recipe) {
