...
public class WorkbenchTransistorsMenu extends AbstractContainerMenu {
    private final WorkbenchTransistorsBlockEntity blockEntity;
    private final Level level;

    public WorkbenchTransistorsMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.WORKBENCH_TRANSISTORS.get());
    }
